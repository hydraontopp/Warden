execute @s[scores={wbmtoggle=1,welcomed=1,worldcustom=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §d"},{"selector":"@s"},{"text":" §ctried passing the world border. Their spawn has been reset."}]}
execute @s[scores={wbmtoggle=1,welcomed=1,worldcustom=0}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §d"},{"selector":"@s"},{"text":" §ctried passing the world border"}]}
