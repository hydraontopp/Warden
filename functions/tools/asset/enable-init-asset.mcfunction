...
scoreboard objectives add warden dummy warden
...
#Staff Protection
scoreboard players set @s[tag=!wardenTrusted] 2DI3N 0
scoreboard players set @s[tag=!wardenTrusted] 39SN230 0
scoreboard players set @s[tag=!wardenTrusted] GFS98 0
scoreboard players set @s[tag=!wardenTrusted] D98AD 0
scoreboard players set @s[tag=!wardenTrusted] I2IO2NO 0
...
function tools/settings/ft_setup_init
function tools/settings/ft_settings
...
event entity @a warden:test_experimental
tellraw @s[scores={has_xx=0}] {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶§6Experimental Features §7: §4Not Enabled §7|| §cExperimental features will not work"}]}
tellraw @s[scores={has_xx=1}] {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶§6Experimental Features §7: §2ENABLED"}]}
tellraw @s[scores={has_gt=1}] {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶§6Gametest Features §7: §2ENABLED"}]}
tellraw @s[scores={has_gt=0}] {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶§6Gametest Features §7: §4Not Enabled §7|| §cGametest features will not work"}]}
