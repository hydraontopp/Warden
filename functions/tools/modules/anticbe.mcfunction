#execute @e[type=command_block_minecart] ~~~ execute @a[r=10,scores={acmtoggle=1}] ~~~ function tools/asset/cbeitemwarn
...
execute @s[scores={acmtoggle=1,has_gt=0},tag=!wardenTrusted] ~~~ clear @s beehive
execute @s[scores={acmtoggle=1,has_gt=0},tag=!wardenTrusted] ~~~ clear @s bee_nest
...
#Remove placed Stuff
execute @s[tag=!wardenTrusted,scores={acmtoggle=1}] ~ ~ ~ fill ~8 ~5 ~8 ~-8 ~-5 ~-8 air 0 replace beehive
execute @s[tag=!wardenTrusted,scores={acmtoggle=1}] ~ ~ ~ fill ~8 ~5 ~8 ~-8 ~-5 ~-8 air 0 replace bee_nest
