...
#execute @s[tag=PermBan] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §d"},{"selector":"@s"},{"text":" §¶§cis tools Global Banned"}]}

#kick @s[tag=PermBan] §¶§7[§cWarden§7]§r §¶ You are tools Global Banned! You may not join realms protected by tools.
