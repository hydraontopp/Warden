...
execute @s[scores={lagtimer=1}] ~~~ execute @r[scores={ltmtoggle=1}] ~~~ function tools/packages/entitycount
execute @s[scores={lagtimer=40..}] ~~~ function tools/packages/autolagclear
execute @s[scores={opamtoggle=1}] ~~~ function tools/modules/opabuse
execute @s[scores={in_combat=1,clmtoggle=1..2}] ~~~ function tools/packages/combatlogger
...
execute @s[tag=!wardenTrusted,scores={fzplr=1}] ~~~ tp @s @e[r=4,name=fzplr]
