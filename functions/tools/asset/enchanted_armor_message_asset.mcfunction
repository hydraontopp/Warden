...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={headen=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §6No Enchanted Armor §bremoved helmet enchants from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1,chesten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §6No Enchanted Armor §bremoved chestplate enchants from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={legen=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §6No Enchanted Armor §bremoved legging enchants from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={feeten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§7[§cWarden§7]§r §¶ §6No Enchanted Armor §bremoved boot enchants from §d"},{"selector":"@s"}]}
